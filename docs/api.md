...
- UI: retained `UIRoot` / `UIContainer` with `UILabel`, `UIImage`, `UIButton`, `UIInput`, and `UISlider`; render through a renderer adapter and route pointer activation without DOM.
